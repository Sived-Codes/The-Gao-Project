...
public class SahayojakQueryReceive extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sahayojak_query_receive);

        getSupportActionBar().setTitle("Public Queries");


        btnSendMsg = (Button) findViewById(R.id.btnSendMsg2_sahyojak);
        etMsg = (EditText) findViewById(R.id.etMessage2_sahyojak);
        lvDiscussion = (ListView) findViewById(R.id.lvConversation2_sahyojak);
        ...
        btnSendMsg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                map2.put("msg",  "Gram Sahyojak ✅ : " + etMsg.getText().toString());
